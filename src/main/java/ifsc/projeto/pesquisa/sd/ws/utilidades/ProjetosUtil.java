...
import ifsc.projeto.pesquisa.sd.ws.propriedades.Situacao;
...
public class ProjetosUtil {
	...
	public static List<Projeto> criarProjetos() {
		...
		lProjeto3.setSituacao(Situacao.EM_EXECUÇÃO.codigo);
		...
		lProjeto14.setDateCadastro(DateUtil.criarData(24, 10, 2019));
		...
		lProjeto15.setDateCadastro(DateUtil.criarData(5, 7, 2019));
		listProjetos.add(lProjeto15);
		
		Projeto lProjeto16 = new Projeto();
		lProjeto16.setCodigo("PILGS944-2019");
		lProjeto16.setTitulo("Avaliação do efeito crioprotetor de hidrolisados proteicos do colágeno na conservação da qualidade de pães de queijo congelados");
		lProjeto16.setTipo("Projeto Interno por Editais (Projeto Novo)");
		lProjeto16.setCategoria("Pesquisa aplicada");
		lProjeto16.setSituacao(Situacao.EM_EXECUÇÃO.codigo);
		lProjeto16.setArea("OORDENADORIA DO CURSO SUPERIOR DE TECNOLOGIA EM PROCESSOS QUÍMICOS (CAMPUS LAGES) (11.01.21.02.16)");
		...
		lProjeto16.setDateCadastro(DateUtil.criarData(11, 3, 2019));
		...
		lProjeto17.setSituacao(Situacao.EM_EXECUÇÃO.codigo);
		lProjeto17.setArea("OORDENADORIA DO CURSO SUPERIOR DE TECNOLOGIA EM PROCESSOS QUÍMICOS (CAMPUS LAGES) (11.01.21.02.16)");
		...
		lProjeto17.setDateCadastro(DateUtil.criarData(29, 3, 2019));
		...
		lProjeto18.setDateCadastro(DateUtil.criarData(24, 10, 2019));
		...
		lProjeto19.setDateCadastro(DateUtil.criarData(31, 10, 2019));
		...
		lProjeto20.setSituacao(Situacao.EM_EXECUÇÃO.codigo);
		...
		lProjeto20.setDateCadastro(DateUtil.criarData(10, 4, 2019));
		...
		lProjeto21.setDateCadastro(DateUtil.criarData(10, 4, 2019));
		...
		lProjeto22.setDateCadastro(DateUtil.criarData(9, 4, 2019));
		...
		lProjeto23.setDateCadastro(DateUtil.criarData(23, 5, 2019));
		...
		lProjeto24.setDateCadastro(DateUtil.criarData(10, 4, 2019));
		...
		lProjeto25.setDateCadastro(DateUtil.criarData(12, 10, 2019));
		...
		lProjeto26.setDateCadastro(DateUtil.criarData(13, 11, 2019));
		...
		lProjeto27.setDateCadastro(DateUtil.criarData(04, 11, 2019));
		...
		lProjeto28.setDateCadastro(DateUtil.criarData(21, 3, 2019));
		...
		lProjeto29.setSituacao(Situacao.EM_EXECUÇÃO.codigo);
		...
		lProjeto29.setDateCadastro(DateUtil.criarData(10, 4, 2019));
		...
		lProjeto30.setDateCadastro(DateUtil.criarData(29, 8, 2019));
		...
		lProjeto31.setDateCadastro(DateUtil.criarData(24, 9, 2019));
		listProjetos.add(lProjeto31);
		
		return listProjetos;
	}
	
	public static List<Projeto> pegarProjetosSituacao(int aSituacao) {
